 ...
 * Style: Bio-Industrial Editorial — cream surface, ink type, mono nav labels with green underline on hover.
 */
    ...
    >
      <div className="container flex h-20 items-center justify-between gap-6">
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  active ? "text-[color:var(--color-nutermia-blue)]" : "text-foreground/75 hover:text-foreground"
                )}
              >
        ...
        <button
          ...
          onClick={() => setOpen((v) => !v)}
          className="lg:hidden inline-flex items-center justify-center rounded-md border border-border bg-card/60 p-2 text-foreground"
        >
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    active ? "text-[color:var(--color-nutermia-blue)]" : "text-foreground/80"
                  )}
                >
                  {link.label}
                </Link>
