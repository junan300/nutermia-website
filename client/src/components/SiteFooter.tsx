...
export function SiteFooter() {
  return (
    <footer className="relative bg-[color:var(--color-nutermia-ink)] text-[color:var(--color-nutermia-cream)] grain">
      ...
      <div className="container relative pt-20 pb-10">
        <div className="grid gap-12 md:grid-cols-12">
          <div className="md:col-span-5 space-y-6">
            ...
            <p className="text-sm leading-relaxed text-white/70 max-w-md">
              {NUTERMIA.legalName} ofrece soluciones integrales para laboratorios farmacéuticos y analíticos
              en Colombia: cromatografía líquida (HPLC), instrumentación, mantenimiento, validación
              IQ/OQ/PQ y consultoría GMP para gases medicinales.
            </p>
          ...
          <div className="md:col-span-3 space-y-4">
            <h4 className="font-mono text-[11px] tracking-widest text-white/50">NAVEGACIÓN</h4>
          ...
          <div className="md:col-span-4 space-y-4">
            <h4 className="font-mono text-[11px] tracking-widest text-white/50">CONTACTO</h4>
        ...
        <div className="mt-12 border-t border-white/10 pt-6 flex flex-wrap gap-x-6 gap-y-3 items-center">
          <span className="font-mono text-[11px] tracking-widest text-white/40">MARCAS REPRESENTADAS</span>
        ...
        <div className="mt-8 flex flex-wrap justify-between gap-4 text-xs text-white/50">
          <p>© {new Date().getFullYear()} {NUTERMIA.legalName}. Todos los derechos reservados.</p>
